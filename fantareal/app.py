...
def build_active_tag_context(active_stage_tags: list[str] | None = None, preset_context: dict[str, Any] | None = None) -> dict[str, Any]:
    state_context = [
        {"tag": tag, "source": "state_journal", "label": "心笺阶段", "ref": {}}
        for tag in (active_stage_tags or [])
    ]
