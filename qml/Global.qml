...
QtObject {
    ...
    readonly property var navMenuModel: [navItems[1], navItems[2], navItems[3], navItems[4], navItems[5], navItems[6], navItems[7], navItems[10], navItems[11]]
    readonly property var moduleCards: [
        {
            key: "cards",
            title: "角色卡",
            desc: "读取 cards、当前角色卡与 Tavern 卡模板状态。",
            color: accentBlue,
            tag: "P0",
            iconSource: HusIcon.IdcardOutlined
        },
        ...
        },
        {
            key: "preset",
            title: "预设",
            desc: "保留 active preset、提示词规则与事件预设素材。",
            color: accentRed,
            tag: "P0",
            iconSource: HusIcon.ProjectOutlined
        },
        ...
        },
        {
            key: "worldbook",
            title: "世界书",
            desc: "读取 worldbook 与 runtime state，预留关键词触发预览。",
            color: accentGold,
            tag: "P0",
            iconSource: HusIcon.BookOutlined
        },
        ...
        },
        {
            key: "plugins",
            title: "插件状态",
            desc: "mods、mobile-chat、auto-saga 与数据库兼容检查。",
            color: accentCyan,
            tag: "P1",
            iconSource: HusIcon.AppstoreOutlined
        }
